...
import FormAddCoupon from '../../../component/form/coupon/FormAddCoupon';
import FormEditCoupon from '../../../component/form/coupon/FormEditCoupon';
...
function ManageCoupon() {
    ...
    return (
        <div>
            <div className="flex justify-center text-3xl font-semibold uppercase">Manage Coupon</div>
            <div className="flex justify-end">
                <div className="add_manager">
                    <Button variant="contained" className="flex gap-2" onClick={handleOpenAdd}>
            ...
            {toggleAdd && <FormAddCoupon toggleAdd={toggleAdd} handleCloseAdd={handleCloseAdd} />}
            {toggleEdit && <FormEditCoupon toggleEdit={toggleEdit} handleCloseEdit={handleCloseEdit} edit={edit} />}
        </div>
    );
}
