...
import { disabledEditItem, enableEditItem } from '../../../redux/reducers/sizeSlice';
...
import FormAddSize from '../../../component/form/size/FormAddSize';
import FormEditSize from '../../../component/form/size/FormEditSize';
...
function ManageSize() {
    ...
    return (
        <div>
            <div className="flex justify-center text-3xl font-semibold uppercase">Manage Size</div>
                                    ...
                                    if (item.isEdit) {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell align="center">{item.sizeName.toUpperCase()}</TableCell>
