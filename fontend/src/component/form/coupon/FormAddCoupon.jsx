import { formatDate, numberPercent, numberStock, validateBlank, validateDate } from '../../../utils/validate';
...
function FormAddCoupon({ toggleAdd, handleCloseAdd }) {
    ...
    const handleAddCoupon = (e) => {
        ...
        if (validateBlank(formCoupon.startDate) || validateBlank(formCoupon.endDate)) {
    ...
    return (
        ...
        >
            <Box sx={style}>
                <form action="" className="flex flex-col gap-2" onSubmit={handleAddCoupon}>
                    <TextField
