...
// function FormAddProductDetail({ toggleAdd, handleCloseAddProductDetail, productId, setListProductDetail }) {
...
//         }
//         // dispatch
//         dispatch(post_add_product_detail({ formProductDetail, idProduct: productId })).then((resp) => {
...
//         >
//             <Box sx={style}>
//                 <form action="" className="flex flex-col gap-3" onSubmit={handleAddProductDetail}>
//                     <TextField
//                         error={errorPrice}
//                         name="price"
