...
// import { numberPrice, numberStock, validateBlank } from '../../../utils/validate';
...
// import { put_update_product_detail } from '../../../redux/thunk/productThunk';
...
// function FormEditProductDetail({ toggleEdit, handleCloseEditProductDetail, edit, productId, setListProductDetail }) {
...
//     // handle select color
//     const [sizeId, setSizeId] = useState(edit.size.id);
//     const handleSelectSizeId = (event) => {
//         setSizeId(event.target.value);
//     };

//     // handle select size
//     const [colorId, setColorId] = useState(edit.color.id);
...
//     const handleUpdateProductDetail = (e) => {
//         e.preventDefault();
...
//                 formProductDetail,
//                 idProductDetail: edit.id,
//                 idProduct: productId,
//             }),
//         ).then((resp) => {
//             setListProductDetail(resp.productDetailResponses);
//             handleCloseEditProductDetail();
//         });
//         resetError();
//     };
...
//         <Modal
//             open={toggleEdit}
//             onClose={handleCloseEditProductDetail}
//             aria-labelledby="modal-modal-title"
//             aria-describedby="modal-modal-description"
//         >
//             <Box sx={style}>
//                 <form action="" className="flex flex-col gap-3" onSubmit={handleUpdateProductDetail}>
//                     <TextField
//                         error={errorPrice}
//                         name="price"
