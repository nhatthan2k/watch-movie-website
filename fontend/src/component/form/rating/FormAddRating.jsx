...
function FormAddRating({ openAddRating, handleCloseAddRating, orderId, handleLoadOrder }) {
    // handle change rate
                    ...
                    <div className="form-container">
                        ...
                        <div className="form">
                            ...
                            <div className="rating pb-5">
                                <input type="radio" id="star-1" name="rate" value="5" onClick={handleChangeRate} />
                                ...
                                <input type="radio" id="star-2" name="rate" value="4" onClick={handleChangeRate} />
                                ...
                                <input type="radio" id="star-3" name="rate" value="3" onClick={handleChangeRate} />
                                ...
                                <input type="radio" id="star-4" name="rate" value="2" onClick={handleChangeRate} />
                                ...
                                <input type="radio" id="star-5" name="rate" value="1" onClick={handleChangeRate} />
